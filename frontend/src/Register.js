...
function Register({ onRegisterSuccess, onSwitchToLogin, onGithubToken }) {
    ...
    <div className="auth-container">
      <div className="auth-box">
        ...
        <div className="auth-content">
          ...
          <button className="social-btn google-btn" onClick={handleGoogleRegister} disabled={loading}>
            <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" />
            Register with Google
          </button>

          <button className="social-btn github-btn" onClick={handleGithubRegister} disabled={loading}>
